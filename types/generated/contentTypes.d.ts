...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    copy_right_text: Attribute.String;
...
export interface ApiMenuMenu extends Schema.CollectionType {
  ...
  attributes: {
    logo: Attribute.Media;
    item: Attribute.Component<'menu.item', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sizes: Attribute.Relation<
      ...
      'api::size.size'
    >;
    add_color: Attribute.Component<'color-name.color', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiStrepStrep extends Schema.CollectionType {
  collectionName: 'streps';
  info: {
    singularName: 'strep';
    pluralName: 'streps';
    displayName: 'Strep';
